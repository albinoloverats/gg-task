...
public class ValidationServiceTest
{
	...
	public void validateIpAddressOkay() throws JSONException
	{
		...
		final var result = target.validateIpAddress(new ValidationQuery(IP_OKAY)).toFuture().join();
	...
	public void validateIpAddressAWS() throws JSONException
	{
		...
		final var result = target.validateIpAddress(new ValidationQuery(IP_AWS)).toFuture().join();
	...
	public void validateIpAddressChina() throws JSONException
	{
		...
		final var result = target.validateIpAddress(new ValidationQuery(IP_BLOCKED)).toFuture().join();
